...
This project will integrate two open-source policy modeling frameworks—CLEWS (Climate, Land, Energy, Water Systems) and OG-Core (Overlapping Generations)—into a single, end-to-end decision-support tool for sustainable development planning.
